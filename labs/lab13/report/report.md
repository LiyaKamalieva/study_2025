...
![рис.1.2](image/1.13.2.png)

Шаг 3. сохраняю файл

![ рис.1.3](image/1.13.3.png)

Шаг 4. использую команду chmod +x research_script.sh

![рис.1.4](image/1.13.4.png)

Шаг 5. открываю программу gedit

![рис.1.5](image/1.13.5.png)


Шаг 6. прописываю скрипт

![рис.1.6](image/1.13.6.png)

Шаг 7. прописываю еще один скрип для запуска

![рис.1.7](image/1.13.7.png)
